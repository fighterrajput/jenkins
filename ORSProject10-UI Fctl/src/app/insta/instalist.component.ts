...
@Component({
  selector: 'app-instalist',
  templateUrl: './instalist.component.html',
  styleUrls: ['./instalist.component.css']
})
export class InstalistComponent extends BaseListCtl implements OnInit {
  ...
  constructor(public locator: ServiceLocatorService, public route: ActivatedRoute, private httpClient: HttpClient) {
    ...
    super(locator.endpoints.INSTA, locator, route);
  }
  ...
  validateInput(event: any, field: string): void {
    ...
    if (field === 'name') {
      ...
      // Restrict input to a maximum length of 15 characters
        ...
        this.nameErrorMessage = 'Name cannot exceed 20 characters';
        this.isValidNameInput = false;
      } else {
